              ...
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-navy-600 mt-1">National Winner at Prodnosis 5.0 at Technex'25</p>
                    <p className="text-navy-600">National Finalist at PMx'25 & Case-O-Nova 6.0</p>
